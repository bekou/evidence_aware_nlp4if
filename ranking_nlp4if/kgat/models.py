...
class inference_model_classifier(nn.Module):
    def __init__(self, bert_model, args):
        super(inference_model_classifier, self).__init__()
        ...
        self.proj_match = nn.Linear(self.bert_hidden_dim, args.num_labels)
    ...
    def forward(self, inputs):
        ...
        score =score.view(-1,self.evi_num,self.num_labels)
        #print (score.shape)
