...
from models import inference_model, inference_model_classifier
...
if __name__ == "__main__":
    ...
    parser.add_argument("--valid_batch_size", default=6, type=int, help="Total batch size for predictions.")
    parser.add_argument('--outdir', required=True, help='path to output directory')
    parser.add_argument('--classifier', required=True,default='kgat', help='choose the type of classifier kgat/basic')
    ...
    if args.classifier=="basic":
        ori_model = inference_model_classifier(bert_model, args)
    elif args.classifier=="kgat":
        ori_model = inference_model(bert_model, args)
    #model = nn.DataParallel(ori_model)
    model = ori_model.cuda()
