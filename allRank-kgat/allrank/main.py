...
import os, sys
file_path = '/home/bekou/projects/allRank-kgat/'
...
def run():
    ...
    #print ('XXXXX')
    '''
    for local_X in train_dl:
        print (local_X[0])
        print (local_X[0].shape)
        print (local_X[1])
        print (local_X[1].shape)
        print (local_X[2])
        print (local_X[2].shape)
    '''
    #for xb, yb, indices in train_dl:
    #    print (xb.shape,yb.shape,indices.shape)   
    #    print (xb,yb,indices)    
