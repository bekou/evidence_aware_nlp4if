...
def parse_args() -> Dict[str, Any]:
    ...
    parser.add_argument("--num_queries", help="Number of queries.", default=4)
    parser.add_argument("--results_len", help="Length of results list for a single query.", default=3)
    parser.add_argument("--num_labels", help="Number of relevance levels.", default=2)
    parser.add_argument("--num_features", help="Number of features of a single item", default=6)
